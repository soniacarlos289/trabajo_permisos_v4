     ...
     while (ida < 11 ) 
        {
         	...
         	if (       document.getElementById('campoc' + ida).value == 1 || document.getElementById('valorc' + ida).value==3 )
     		    ...
     		    {
                         campo_final= campo_final + document.getElementById('TR_HORA_' + ida).value + ':' +
                                ...
                                <tr>
                                    ...
                                    <table width="75%" border="0" cellspacing="0" cellpadding="2">
                                      <form name="formBotonera" method=post action="index.jsp">
                                        <tr>
                                          <td width="76">
                                          <input type="button" value="Regenerar" name="Nuevo" onClick="javascript:regenera();" >                                          </td>
                                          <td width="60">&nbsp;</td>
                                          <td width="135">&nbsp;</td>
										...
										<a href="javascript:añadir();"><img src="../../imagen/new.png" alt="Nuevo"	width="20" height="20" border="0"></a></div> <form name="formFICHA" method=post action="procesa_tran.jsp"> <table width="35%" border="1" cellspacing="1" cellpadding="4">
                                            ...
                                            <tr>
                                              <td align="center" valign="bottom" nowrap bgcolor="#FFFFFF">
										        <div id="c<%= Repeat1__index %>" style="DISPLAY: ">
											    <select name="TR_HORA_<%= Repeat1__index %>" onChange="document.formFICHA.valorc<%= Repeat1__index %>.value=2;">
                                    <%
...
%>
								   ...
								   <select name="TR_MINUTO_<%= Repeat1__index %>" onChange="document.formFICHA.valorc<%= Repeat1__index %>.value=2;">
                                    <%
...
%>
								   ...
								   <a href="javascript:borrar('c<%= Repeat1__index %>');"> <img src="../../imagen/delete.png" alt="Nuevo"	width="20" height="20" border="0"></a><input type="hidden" name="campoc<%= Repeat1__index %>" value="1">
								   <input type="hidden" name="valorc<%= Repeat1__index %>" value="0">
										        </div></td>
                                        </tr>
                                            <% } /* end !RSQUERY_isEmpty */ %>
...
RSTR_HORA_isEmpty = !RSTR_HORA_hasData;
%>
                                  </select><select name="TR_MINUTO_<%= Repeat1__index %>" onChange="document.formFICHA.valorc<%= Repeat1__index %>.value=2;">
                                    <%
while (RSTR_MINUTO_hasData) {
%>
...
%>
                                  ...
                                  <a href="javascript:borrar('c<%= Repeat1__index %>');"> <img src="../../imagen/delete.png" alt="Borrar"	width="20" height="20" border="0"></a> <input type="hidden" name="campoc<%= Repeat1__index %>" value="0">
								  <input type="hidden" name="valorc<%= Repeat1__index %>" value="0">
								  </div>	 </td>
