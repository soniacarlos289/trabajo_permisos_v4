...
PreparedStatement StatementRSQUERY = ConnRSQUERY.prepareStatement("select distinct fc.id_funcionario as ID_FUNCIONARIO,    fc.NOMBRE || ' ' || Ape1 || ' ' || Ape2 as nombre, HORAS_TRAJADAS_MES(fc.id_funcionario,21,1,  " + RSTIPOPERMISO__MMColParam2  + ") as ENERO,  HORAS_TRAJADAS_MES(fc.id_funcionario,21,2,  " + RSTIPOPERMISO__MMColParam2  + ") as FEBRERO,     HORAS_TRAJADAS_MES(fc.id_funcionario,21,3,  " + RSTIPOPERMISO__MMColParam2  + ") as MARZO, HORAS_TRAJADAS_MES(fc.id_funcionario,21,4,  " + RSTIPOPERMISO__MMColParam2  + ") as ABRIL,  HORAS_TRAJADAS_MES(fc.id_funcionario,21,5,  " + RSTIPOPERMISO__MMColParam2  + ") as MAYO,     HORAS_TRAJADAS_MES(fc.id_funcionario,21,6,  " + RSTIPOPERMISO__MMColParam2  + ") as JUNIO, HORAS_TRAJADAS_MES(fc.id_funcionario,21,7,  " + RSTIPOPERMISO__MMColParam2  + ") as JULIO,   HORAS_TRAJADAS_MES(fc.id_funcionario,21,8,  " + RSTIPOPERMISO__MMColParam2  + ") as AGOSTO,  HORAS_TRAJADAS_MES(fc.id_funcionario,21,9,  " + RSTIPOPERMISO__MMColParam2  + ") as SEPTIEMBRE, HORAS_TRAJADAS_MES(fc.id_funcionario,21,10,  " + RSTIPOPERMISO__MMColParam2  + ") as OCTUBRE,     HORAS_TRAJADAS_MES(fc.id_funcionario,21,11,  " + RSTIPOPERMISO__MMColParam2  + ") as NOVIEMBRE,       HORAS_TRAJADAS_MES(fc.id_funcionario,21,12,  " + RSTIPOPERMISO__MMColParam2  + ") as DICIEMBRE,    HORAS_TRAJADAS_MES(fc.id_funcionario,21,13,  " + RSTIPOPERMISO__MMColParam2  + ") as TOTAL,ape1 from  personal_new fc  where         (fecha_baja > sysdate or fecha_baja is null) and         fc.tipo_funcionario2=21 order by ape1");
...
{  
  ...
  response.setHeader("Content-Disposition", "attachment; filename=" + "Saldos policias.xls");
}
   ...
   <div id="form">
     <div>
	  <ul id="subtabh">		
		...
		<li><a href="index_policias.jsp" id="current">Policias</a></li>					
...
%>   
                                        ...
                                        <td  align="right"><a href='index_policias.jsp?ID_EXCEL=1&ID_ANO=<%= RSTIPOPERMISO__MMColParam2%>'><img	src="../../imagen/excel.jpg" alt="Excel" width="20" height="20" border="0"></a></td> 
                                      </tr>
                                      <tr> 
