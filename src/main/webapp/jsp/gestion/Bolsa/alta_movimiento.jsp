...
<%
String RSQUEYBOLSA__MMColParam8 = "A";
...
%>
<%
String RSQUEYBOLSA__MMColParam7 = "0";
...
PreparedStatement StatementTIPO_BOLSA = ConnTIPO_BOLSA.prepareStatement("select id_tipo_movimiento,  desc_tipo_movimiento  from BOLSA_TIPO_MOVIMIENTO where id_tipo_movimiento in (1,3,4,6,7) order by 2 ");
...
<div>
	...
	<table width="95%" border="0" cellspacing="5" cellpadding="0">
                        ...
                        <form name="formBolsa" method="post" action="movimiento_result.jsp"> 						
                                      <tr bgcolor="#FFFFDD">                                      
                                        <td colspan="8"><div align="center"> <strong>Creaci&oacute;n de Movimiento </strong></div>                                          
                              ...
                              <td bgcolor="#E0E0E0" valign="top" colspan="2"> 
                                <table align="center" cellpadding="2" cellspacing="1" border="0" width="100%">
								  ...
								  <tr valign="baseline" bgcolor="#f2f2f2"> 
                                    ...
                                    <td><select name="PERIODO" maxlength="100">
                                                  <%
...
%>
                                      ...
                                      <input type="hidden" name="ID_TIPO_OPERACION" value="A" size="6" maxlength="4">
...
%>
                                  ...
                                  <tr valign="baseline" bgcolor="#f2f2f2"> 
                                    <td nowrap align="right" width="28%" bgcolor="#f2f2f2" valign="middle">Descripci&oacute;n 
                                      :</td>
                                    <td> 
                                      <textarea name="OBSERVACIONES" cols="60" rows="3" id="OBSERVACIONES" value="<%= RSQUEYBOLSA__MMColParam9 %>"></textarea>                                    </td>
                                  </tr>
                                </table>
                              </td>
                            </tr>
									   <tr>
									        <td colspan="8" align="center" bgcolor="#66CCFF"><input type="submit" value="Guardar Movimiento" name="Guardar" onClick="javascript:envia_unavez();"></td>
                          </tr> 
