...
<xsl:template match="/"> 
<HEAD><TITLE>Listado de ausencias</TITLE></HEAD>
    ...
    <TD bgcolor="#000000">
      <TABLE border="0" cellspacing="1" cellpadding="5" width="100%">
        <TR>
          ...
          <TD align="center" bgcolor="#CCCCCC"><SPAN STYLE="font-family: Arial, Helvetica, Verdana, serif; font-size: 12px"><B>AUSENCIA</B></SPAN></TD>
          ...
          <TD align="center" bgcolor="#CCCCCC"><SPAN STYLE="font-family: Arial, Helvetica, Verdana, serif; font-size: 12px"><B>JUSTIFICADO</B></SPAN></TD>
        ...
        <TR>
          ...
          <TD align="center" bgcolor="#FFFFFF"> <SPAN STYLE="font-family: Arial, Helvetica, Verdana, serif; font-size: 12px"><xsl:value-of select="@ID_TIPO_AUSENCIA"/></SPAN></TD>
          <TD align="center" bgcolor="#FFFFFF"> <SPAN STYLE="font-family: Arial, Helvetica, Verdana, serif; font-size: 12px"><xsl:value-of select="@FECHA_AUSENCIA"/></SPAN></TD>
