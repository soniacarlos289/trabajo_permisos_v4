...
%>
// --- Inicio Comentario ---
// Descripción: Obtener los tipos de ausencias disponibles para mostrar en el selector de edición.
...
//                 Parametrizar el año '2016' para usar año actual o dinámico.
// --- Fin Comentario ---
...
%>
// --- Inicio Comentario ---
// Descripción: Obtener todos los datos de una ausencia específica para editarla.
//              Incluye fechas, horas, estado, justificación y observaciones.
...
//                 Añadir join explícito en lugar de join implícito en WHERE.
// --- Fin Comentario ---
...
%>
// --- Inicio Comentario ---
// Descripción: Obtener el catálogo de estados de permisos/ausencias para el selector.
//              Lista todos los posibles estados que puede tener una ausencia.
// Parámetros: Ninguno.
// Posible mejora: Consulta simple de catálogo. Considerar caché de aplicación para reducir consultas.
// --- Fin Comentario ---
