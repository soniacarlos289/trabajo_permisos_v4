...
PreparedStatement StatementRSQUERYJS = ConnRSQUERYJS.prepareStatement("SELECT f.id_funcionario,lpad(id_js,6,'0') as id_js  ,pe.nombre || ' ' || pe.ape1||' ' || pe.ape2 as nombre  FROM personal_new pe, funcionario_firma f  WHERE f.id_funcionario='" + RSQUERYJS__MMColParam1 + "' and         pe.id_funcionario=id_js");
...
PreparedStatement StatementRSQUERYJA = ConnRSQUERYJA.prepareStatement("SELECT f.id_funcionario,lpad(id_ja,6,'0') as id_ja  ,pe.nombre || ' ' || pe.ape1||' ' || pe.ape2 as nombre  FROM personal_new pe, funcionario_firma f  WHERE f.id_funcionario='" + RSQUERYJA__MMColParam1 + "' and         pe.id_funcionario=id_ja");
 ...
 <tr>
    ...
    <tr>
      <th colspan="3" scope="row"><div align="center">
          <input type="submit" name="Submit2" value="Guardar Cambios Firma">
      </div></th>
    </tr>
  </table>
