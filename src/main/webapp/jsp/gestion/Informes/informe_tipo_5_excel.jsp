...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr>
   <th colspan="14" align=center bgcolor="#E6E6E6">Turnos Policía</th>                                             
	    ...
	    %>   	  
            <tr>
   		   ...
   		   <td  align=center  <%=RSCOLOR %> >
   	          	        	...
   	          	        	<%=(((RSDATOS_data = RSDATOS.getObject("CAMPO2"))==null || RSDATOS.wasNull())?"":RSDATOS_data)%>
