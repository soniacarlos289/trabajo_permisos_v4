...
PreparedStatement StatementRSDATOS = ConnRSDATOS.prepareStatement("select id_col,to_char(mod(id_col, 2)) as impar, campo1, campo2,  to_date( campo3 || ' ' || lpad(campo4,5,'0'),'dd/mm/yyyy hh24:mi') as ordena_fecha,    campo3, campo31, campo4, campo5, campo6, campo7, campo8, campo9, campo10, campo11, campo12, campo13, campo14, campo15,  campo16, campo17, campo18, campo19, campo20 from fichaje_informe_campo where ID_EJECUCION="+ RS_INFORME +" ORDER BY  campo1,campo2,ordena_fecha");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr>
   <th colspan="14" align=center bgcolor="#E6E6E6">Fichajes en estas fechas</th>                                             
