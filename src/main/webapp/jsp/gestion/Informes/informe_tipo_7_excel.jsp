...
{  
  response.setContentType("application/vnd.ms-excel");
	 if (!RSINFORME_isEmpty ) {
        response.setHeader("Content-Disposition", "attachment; filename=" + "Estadisticas_x_año_"+  (((RSINFORME_data = RSINFORME.getObject("FILTRO_1_TXT"))==null || RSINFORME.wasNull())?"":RSINFORME_data) + "_"  +  (((RSINFORME_data = RSINFORME.getObject("FILTRO_2_TXT"))==null || RSINFORME.wasNull())?"":RSINFORME_data) +".xls");
      } else { 
           response.setHeader("Content-Disposition", "attachment; filename=" + "Estadisticas_x_año_"+".xls");
      }
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr>
   <th colspan="14" align=center bgcolor="#E6E6E6">Estadisticas Funcionario por año.</th>                                             
    ...
    <table width="100%" border="1" cellspacing="1" cellpadding="1">
      <tr>
        ...
        <th  align=center bgcolor="#F2F2F2" ><%=(((RSCABECERA_data = RSCABECERA.getObject("CAMPO16"))==null || RSCABECERA.wasNull())?"":RSCABECERA_data)%></th>   	   
   	    ...
   	    <th  align=center bgcolor="#F2F2F2" ><%=(((RSCABECERA_data = RSCABECERA.getObject("CAMPO18"))==null || RSCABECERA.wasNull())?"":RSCABECERA_data)%></th>
   	    <th  align=center bgcolor="#F2F2F2" ><%=(((RSCABECERA_data = RSCABECERA.getObject("CAMPO19"))==null || RSCABECERA.wasNull())?"":RSCABECERA_data)%></th>
   	    <th  align=center bgcolor="#F2F2F2" ><%=(((RSCABECERA_data = RSCABECERA.getObject("CAMPO20"))==null || RSCABECERA.wasNull())?"":RSCABECERA_data)%></th>
   	    <th  align=center bgcolor="#F2F2F2" ><%=(((RSCABECERA_data = RSCABECERA.getObject("CAMPO21"))==null || RSCABECERA.wasNull())?"":RSCABECERA_data)%></th>
   	    <th  align=center bgcolor="#F2F2F2" ><%=(((RSCABECERA_data = RSCABECERA.getObject("CAMPO22"))==null || RSCABECERA.wasNull())?"":RSCABECERA_data)%></th>
	   ...
	   <% while ((RSDATOS_hasData)&&(Repeat1__numRows-- != 0)) { 
	    ...
	    %>   	  
            <tr><td align=center  <%=RSCOLOR %>><%=(((RSDATOS_data = RSDATOS.getObject("CAMPO1"))==null || RSDATOS.wasNull())?"":RSDATOS_data)%></td>
   		        ...
   		        <td align=center  <%=RSCOLOR %>><%=(((RSDATOS_data = RSDATOS.getObject("CAMPO17"))==null || RSDATOS.wasNull())?"":RSDATOS_data)%></td>
   		        <td align=center  <%=RSCOLOR %>><%=(((RSDATOS_data = RSDATOS.getObject("CAMPO18"))==null || RSDATOS.wasNull())?"":RSDATOS_data)%></td>   
   		        <td align=center  <%=RSCOLOR %>><%=(((RSDATOS_data = RSDATOS.getObject("CAMPO19"))==null || RSDATOS.wasNull())?"":RSDATOS_data)%></td>
   		        <td align=center  <%=RSCOLOR %>><%=(((RSDATOS_data = RSDATOS.getObject("CAMPO20"))==null || RSDATOS.wasNull())?"":RSDATOS_data)%></td>  
   		        <td align=center  <%=RSCOLOR %>><%=(((RSDATOS_data = RSDATOS.getObject("CAMPO21"))==null || RSDATOS.wasNull())?"":RSDATOS_data)%></td>
   		        <td align=center  <%=RSCOLOR %>><%=(((RSDATOS_data = RSDATOS.getObject("CAMPO22"))==null || RSDATOS.wasNull())?"":RSDATOS_data)%></td>   
