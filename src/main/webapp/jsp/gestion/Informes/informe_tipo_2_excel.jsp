...
PreparedStatement StatementRSDATOS = ConnRSDATOS.prepareStatement("select id_col,to_char(mod(id_col, 2)) as impar,lpad(campo1,6,'0') as campo1, campo2,campo3, campo31, campo4, campo5, campo6, campo7, campo8, campo9, campo10, campo11, campo12, campo13, campo14, campo15,  campo16, campo17, campo18, campo19, campo20 from fichaje_informe_campo where ID_EJECUCION='"+ RS_INFORME +"' order by campo8 asc,id_col");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr>
   <th colspan="14" align=center bgcolor="#E6E6E6">Resumen Saldo</th>                                             
  ...
  <td colspan=14>
	...
	<% if (!RSDATOS_isEmpty ) { %>
	   <% while ((RSDATOS_hasData)&&(Repeat1__numRows-- != 0)) { 
	    ...
	    %>   	  
            <tr>
  	        	<td  colspan="2" align=left  ><%=(((RSDATOS_data = RSDATOS.getObject("CAMPO1"))==null || RSDATOS.wasNull())?"":RSDATOS_data)%>-<%=(((RSDATOS_data = RSDATOS.getObject("CAMPO2"))==null || RSDATOS.wasNull())?"":RSDATOS_data)%></td>
   				<td  align=center  ><%=(((RSDATOS_data = RSDATOS.getObject("CAMPO31"))==null || RSDATOS.wasNull())?"":RSDATOS_data)%> </td>  					
