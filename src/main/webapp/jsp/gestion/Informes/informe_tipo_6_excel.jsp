...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr>
   <th colspan="14" align=center bgcolor="#E6E6E6">Turnos Bomberos</th>                                             
    ...
    <table width="100%" border="1" cellspacing="1" cellpadding="1">
      <tr>
         <th  align=center bgcolor="#F2F2F2" ><%=(((RSCABECERA_data = RSCABECERA.getObject("CAMPO5"))==null || RSCABECERA.wasNull())?"":RSCABECERA_data)%></th>
   	    ...
   	    <th  align=left bgcolor="#F2F2F2" ><%=(((RSCABECERA_data = RSCABECERA.getObject("CAMPO4"))==null || RSCABECERA.wasNull())?"":RSCABECERA_data)%></th>
        <th  align=left bgcolor="#F2F2F2" ><%=(((RSCABECERA_data = RSCABECERA.getObject("CAMPO3"))==null || RSCABECERA.wasNull())?"":RSCABECERA_data)%></th>
         </tr>
	<% if (!RSDATOS_isEmpty ) { %>
	   <% while ((RSDATOS_hasData)&&(Repeat1__numRows-- != 0)) { 

               	   RSFuncionario= (String) (((RSDATOS_data = RSDATOS.getObject("CAMPO5"))==null || RSDATOS.wasNull())?"":RSDATOS_data); 
	    ...
	    %>   	  
            <tr>
  	           <td  <%=RSCOLOR %>  align=center  >  <%=(((RSDATOS_data = RSDATOS.getObject("CAMPO5"))==null || RSDATOS.wasNull())?"":RSDATOS_data)%></td>   			
   	           ...
   	           <td  <%=RSCOLOR %>  align=left  >  <%=(((RSDATOS_data = RSDATOS.getObject("CAMPO4"))==null || RSDATOS.wasNull())?"":RSDATOS_data)%></td>   			
   			   <td  <%=RSCOLOR %>  align=left  >  <%=(((RSDATOS_data = RSDATOS.getObject("CAMPO3"))==null || RSDATOS.wasNull())?"":RSDATOS_data)%></td>
   			</tr>
                              <%
  Repeat1__index++;
